package com.ydc.schedule.service;
...
public class ScheduleRefresh {
	private static final Logger log = LoggerFactory.getLogger(ScheduleRefresh.class);
    ...
    public void scheduleUpdateCronTrigger() throws SchedulerException {
        ...
        log.info("currentCron : {}    -----   searchCron: {} ",currentCron ,searchCron);
